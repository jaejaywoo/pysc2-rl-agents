...
export SLACK_API_TOKEN='xoxp-275696664358-274748830675-396209502564-4e013c28a4e30d5eaf6580b87ca977fc'
...
python run.py defeat_roaches                   --debug --lr 0.00095 --save_iters 500 --nchw --envs 16 --map DefeatRoaches
